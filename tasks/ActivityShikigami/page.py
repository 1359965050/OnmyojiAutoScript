...
page_act_map.connect(page_act, GlobalGameAssets.I_UI_BACK_YELLOW, key="page_act_map->page_act")
page_act.connect(page_act_map, ActivityShikigamiAssets.I_TO_BATTLE_MAIN, key="page_act->page_act_map")
# 体力爬塔页面
