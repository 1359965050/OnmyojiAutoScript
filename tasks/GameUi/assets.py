...
class GameUiAssets: 
	...
	# 探索前往英杰试炼 
	I_EXPLORATION_GOTO_HERO_TEST = RuleImage(roi_front=(731,634,58,61), roi_back=(7,605,1272,113), threshold=0.65, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_hero_test.png")
