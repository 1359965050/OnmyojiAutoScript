...
class CustomOcr(RuleOcr):
    def coord(self) -> tuple:
        # Return a random coordinate inside (834, 644, 45, 39)
        x, y, w, h = 834, 644, 45, 39
...
class GameUiAssets: 
	...
	# 六道之门界面校验 
	O_CHECK_SIX_GATES = RuleOcr(roi=(80,15,170,50), area=(80,15,170,50), mode="Full", method="Default", keyword="六道之门", name="check_six_gates")
	...
	# description 
	I_MAIN_GOTO_EXPLORATION = RuleImage(roi_front=(659,116,36,61), roi_back=(243,100,933,211), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_main_goto_exploration.png")
	# description 
	...
	# 探索前往六道之门 
	O_EXPLORATION_GOTO_SIX_GATES = CustomOcr(roi=(780,620,150,100), area=(780,620,150,100), mode="Full", method="Default", keyword="六道", name="exploration_goto_six_gates")
	# 探索前往契灵之境 
