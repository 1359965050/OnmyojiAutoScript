...
class GameUiAssets: 
	...
	# Image Rule Assets
	# 探索界面标识 
	I_CHECK_EXPLORATION = RuleImage(roi_front=(1139,110,41,36), roi_back=(1119,90,81,76), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_exploration.png")
	# 探索前往觉醒 
	...
	# 探索前往六道之门 
	I_EXPLORATION_GOTO_SIX_GATES = RuleImage(roi_front=(900,620,100,95), roi_back=(860,590,180,140), threshold=0.5, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_six_gates.png")
	# 探索前往契灵之境 
	...
	# 六道之门标题识别 
	O_CHECK_SIX_GATES_TITLE = RuleOcr(roi=(40,5,180,55), area=(40,5,180,55), mode="Single", method="Default", keyword="六道", name="check_six_gates_title")
	# 六道之门右下角印记识别 
	O_CHECK_SIX_GATES_SEAL = RuleOcr(roi=(1160,635,60,55), area=(1160,635,60,55), mode="Single", method="Default", keyword="印记", name="check_six_gates_seal")
