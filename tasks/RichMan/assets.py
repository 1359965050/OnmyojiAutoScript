...
class RichManAssets: 
	...
	# description 
	I_MALL_SCALES_SURE = RuleImage(roi_front=(1195,100,62,85), roi_back=(1160,70,115,145), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_scales_sure.png")
	# 契灵商店 
	I_MALL_BONDLINGS_SURE = RuleImage(roi_front=(1194,421,69,74), roi_back=(1160,370,120,230), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_bondlings_sure.png")
	# 已选中契灵商店 
	...
	# 契灵商店 
	I_MALL_BONDLINGS_CHECK = RuleImage(roi_front=(355,186,34,104), roi_back=(330,160,90,150), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_bondlings_check.png")
	# 杂货铺 
