...
class SixRealmsAssets: 
	...
	# 流羽剑术 
	I_PK_SKILL_LIUYU = RuleImage(roi_front=(0,0,50,50), roi_back=(113,145,960,200), threshold=0.75, method="Template matching", file="./tasks/SixRealms/peacock_kingdom/pk/pk_pk_skill_liuyu.png")
	#  
	I_PK_SELECT_0 = RuleImage(roi_front=(245,500,91,41), roi_back=(245,450,91,200), threshold=0.8, method="Template matching", file="./tasks/SixRealms/peacock_kingdom/pk/pk_pk_select_0.png")
	#  
	I_PK_SELECT_1 = RuleImage(roi_front=(600,498,91,41), roi_back=(600,450,91,200), threshold=0.8, method="Template matching", file="./tasks/SixRealms/peacock_kingdom/pk/pk_pk_select_1.png")
	#  
	I_PK_SELECT_2 = RuleImage(roi_front=(955,499,91,41), roi_back=(955,450,91,200), threshold=0.8, method="Template matching", file="./tasks/SixRealms/peacock_kingdom/pk/pk_pk_select_2.png")
	#  
	I_PK_SELECT_3 = RuleImage(roi_front=(423,498,91,41), roi_back=(423,450,91,200), threshold=0.8, method="Template matching", file="./tasks/SixRealms/peacock_kingdom/pk/pk_pk_select_3.png")
	#  
	I_PK_SELECT_4 = RuleImage(roi_front=(779,499,91,41), roi_back=(779,450,91,200), threshold=0.8, method="Template matching", file="./tasks/SixRealms/peacock_kingdom/pk/pk_pk_select_4.png")
